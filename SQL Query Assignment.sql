...
select c.course_id, i.first_name, i.last_name, count(c.num_credits) from instructor i join course c on c.instructor_id = i.instructor_id join student s on s.advisor_id = i.instructor_id where s.student_id = 1 group by c.course_id , i.first_name , i.last_name;
